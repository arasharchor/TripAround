...
public class TripResultsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.getActionBar()
				.setTitle(Html.fromHtml("<font color='#FFFFFF' Bold=\"true\" size = \"20\"> Berlin </font>"));
		...
		mReviewDataListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
				...
				// if the measurement is done, go to the MeasurementStatus
				// screen
		...
		// displays the popup context menu to either delete or resend
		// measurement
	...
	private ArrayList<ReviewData> getReviewData() {
		...
		arrayList.add(rev4);
		arrayList.add(rev5);
		System.err.println("ArrayList<ReviewData> is populated!>");
		return arrayList;
	}
